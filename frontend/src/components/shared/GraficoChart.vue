  ...
  return {
    ...
    plugins: {
      legend: {
        display: legend,
        position: "bottom",
        labels: { color: c.text, usePointStyle: true, pointStyle: "circle", padding: 16, font: { size: 12 } },
      },
      tooltip: {
        backgroundColor: document.documentElement.classList.contains("dark") ? "#1b2024" : "#0f1720",
        titleColor: "#fff",
        bodyColor: "#e2e8f0",
        padding: 12,
        cornerRadius: 10,
